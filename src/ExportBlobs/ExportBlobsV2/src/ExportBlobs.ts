...
async function run() {
    try {
        ...
        let ClientKey: string = convertToNullIfUndefined(tl.getInput('ClientKey', false));
        let ClientSecret: string = convertToNullIfUndefined(tl.getInput('ClientSecret', false));
        let ProjectId: string = convertToNullIfUndefined(tl.getInput('ProjectId', false));
        let Environment: string = convertToNullIfUndefined(tl.getInput('Environment', false));
